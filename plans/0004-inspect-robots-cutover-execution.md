...
git -C ~/inspect-robots     remote set-url origin git@github.com:limike954/trajectory-data-00006.git
git -C ~/inspect-robots-yam remote set-url origin git@github.com:limike954/trajectory-data-00006-yam.git
```
...
```bash
# GitHub descriptions
gh repo edit limike954/trajectory-data-00006     --description "Inspect Robots — the Inspect AI for robotics (VLA/physical-AI eval framework)"
gh repo edit limike954/trajectory-data-00006-yam --description "Inspect Robots adapters for I2RT YAM bimanual arms driven by MolmoAct2"

# Pages redeploys from the docs workflow; confirm it lands at:
#   https://robocurve.github.io/inspect-robots/
gh run list -R limike954/trajectory-data-00006 --workflow docs.yml
```
